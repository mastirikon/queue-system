...
- [x] Создан файл `internal/domain/task.go` с моделями
- [x] Создан файл `internal/domain/task_types.go` с константами
- [x] Создан файл `internal/queue/client.go` с Asynq Client
- [x] Код компилируется без ошибок:
  - `go build ./internal/domain`
  - `go build ./internal/queue`
- [x] Результаты компиляции показаны ментору
- [x] Исправлены ошибки с AsynqOptionsConfig (убрано лишнее парсинг env)
