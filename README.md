...
### Сценарий 1: Быстрый деплой (скрипт)
...
### Сценарий 2: Деплой через Makefile
...
### Сценарий 3: Тестирование перед деплоем
...
### Сценарий 4: Изменения в конфигурации

```bash
# 1. Редактируешь .env.production
nano .env.production
